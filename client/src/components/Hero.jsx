          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <p className="text-sm md:text-sm text-gray-600 leading-relaxed max-w-2xl">
                Effortlessly manage your expenses and budgets with our intelligent
                expense tracker. Gain insights, save money, and achieve your financial
                goals faster.
              </p>
            </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center space-x-1">
                    <img src={assets.group_profiles} alt="group-profile" className="w-22"/>
                  <div className="text-gray-700 font-medium ml-4">10k+ Users</div>
                </div>
